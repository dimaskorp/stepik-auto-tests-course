...
class ProductPage(BasePage):
    ...
    def should_not_be_success_message_is_not_element_present(self):
        ...
        assert self.is_not_element_present(
            *ProductPageLocators.MESSAGE_PRODUCT_ADDED_TO_CART), "Success message is presented, but should not be"
    ...
    def should_be_product_add_to_cart(self):
        ...
        header = self.browser.find_element_by_css_selector(
    ...
    def cost_basket_coincides_price_of_product(self):
        ...
        cost_basket = self.browser.find_element_by_css_selector(
            "#content_inner > article > div.row > div.col-sm-6.product_main > p.price_color")
        cost_basket_text = cost_basket.text
        price_product = self.browser.find_element_by_css_selector(
